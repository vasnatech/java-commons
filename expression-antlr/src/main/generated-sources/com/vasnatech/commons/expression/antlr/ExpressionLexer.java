// Generated from com/vasnatech/commons/expression/antlr/ExpressionLexer.g4 by ANTLR 4.12.0
...
public class ExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DECIMAL_LITERAL", "FLOAT_LITERAL", "BOOLEAN_LITERAL", "STRING_LITERAL", 
			"LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", "DOT", "QUOTE", "AND", 
			"OR", "BANG", "ASSIGN", "EQ", "NOTEQUAL", "GT", "LT", "LE", "GE", "ADD", 
			"SUB", "MUL", "DIV", "MOD", "WS", "IDENTIFIER", "Digits", "LetterOrDigit", 
			"Letter", "EscapeSequence", "HexDigit"
		};
	}
