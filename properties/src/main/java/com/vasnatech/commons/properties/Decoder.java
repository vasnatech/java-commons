...
public interface Decoder extends Deserializer {
    ...
    <T, R extends T> R fromByteArray(byte[] bytes, Class<T> rawClass, Class<?>... parameterClasses) throws IOException;

    <T, R extends T> R fromString(String jsonString, Class<T> rawClass, Class<?>... parameterClasses) throws IOException;

    <T, R extends T> R fromInputStream(InputStream in, Class<T> rawClass, Class<?>... parameterClasses) throws IOException;

    <T, R extends T> R fromReader(Reader reader, Class<T> rawClass, Class<?>... parameterClasses) throws IOException;
    ...
    default Map<String, ?> fromStringToMap(String propertiesString) throws IOException {
        return fromString(propertiesString, Map.class, String.class, Object.class);
    }
